...
function App() {
  // 리액트에서는 컴포넌트에서, 요소 여러 개를 왜 하나의 요소로 꼭 감싸 주어야하나?
  ...
  return (
    ...
    <>
      ...
      {name === '정찬우' ? <h4>정찬우가 맞습니다.</h4> : null}
      <h3>5. && 연산자 이용해보기.</h3>
      {name === '정찬우' && <h4>정찬우가 맞습니다.</h4>}
